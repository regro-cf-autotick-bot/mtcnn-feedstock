...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mtcnn-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9067&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mtcnn-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mtcnn` can be installed with:

```
conda install mtcnn
```

It is possible to list all of the versions of `mtcnn` available on your platform with:
